...
//========================================================================
// 函数: void	Writebyte(u8 addr, u8 dat)
// 描述: I2C写入数据函数.
// 参数: addr: 指定地址, dat写入数据.
// 返回: none.
// 版本: V1.0, 2020-09-15
//========================================================================
void Writebyte(u8 addr, u8 dat)  /*  Address,date   */
{
	EAXSFR();		/* MOVX A,@DPTR/MOVX @DPTR,A指令的操作对象为扩展SFR(XSFR) */
	Start();                                //发送起始命令
...
//========================================================================
// 函数: void	Readbyte(u8 addr)
// 描述: I2C读取1字节数据函数.
// 参数: addr: 指定地址.
// 返回: dat.
// 版本: V1.0, 2020-09-15
//========================================================================
u8 Readbyte(u8 addr)   /*  WordAddress,First Data Address,Byte lenth   */
{
	u8 dat;
	EAXSFR();		/* MOVX A,@DPTR/MOVX @DPTR,A指令的操作对象为扩展SFR(XSFR) */
	Start();                                //发送起始命令
